...
public class LruCache extends CacheManager {

    public LruCache(int cacheSize, CacheStrategy cacheStrategy) {
        super(cacheSize, cacheStrategy);
        map = new LinkedHashMapCache(cacheSize, /*isAccessOrder=*/ true);
    }
