    ...
    public boolean sshServerStart(String replacementPolicy,int cacheSize){
        ...
        try {
            if (System.getProperty("os.name").toLowerCase().contains("win")) {
                ...
                String sent="ssh -n herna130@127.0.0.1 nohup java -jar ./ECEFourthYear/ECE419/m2/M2/m2-server.jar "+port+" "+cacheSize+" "+replacementPolicy+" ALL "+ zkHostName + ":" + zkPort+" /ECE419 "+name+" &";
                System.out.println(sent);
                proc = run.exec("ssh -o StrictHostKeyChecking=no -n herna130@127.0.0.1 nohup java -jar ./ECEFourthYear/ECE419/m2/M2/m2-server.jar "+port+" "+cacheSize+" "+replacementPolicy+" ALL "+ zkHostName + ":" + zkPort+" /ECE419 "+name+" &");
            }
