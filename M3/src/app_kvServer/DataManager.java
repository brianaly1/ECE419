...
public class DataManager {
        ...
        for (Map.Entry<String, Vector<String>> addressToKeys : addressToKeysMap.entrySet()) {
            ...
            for (String kvKey : addressToKeys.getValue()) {
                ...
                try {
                    ...
                    serverConnection.put(kvKey, value, toReplicate);
                    ...
                    String value = fileManager.getKV(kvKey);
                    reconnectAndPut(kvKey, value, toReplicate, addressToKeys.getKey());
                }
            }
    ...
    public void reconnectAndPut(String key, String value, boolean toReplicate, String address){
        for (int i=0; i<5; i++) {
            try {
                serverConnection = new ServerConnection(address);
                serverConnection.put(key, value, toReplicate);
                return;
            } catch (Exception e) {
